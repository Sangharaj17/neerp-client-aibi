...
const handleCancel = () => {
  ...
  const handleButtonClick = async (type, id = null) => {
    ...
    if (type === 'export') {
      ...
      router.push(`/${tenant}/dashboard/lead-management/lead-list/add-lead`);
    } else if(type === 'delete') {

    }
     else if (type === 'view-enquiry') {
      router.push(
        `/${tenant}/dashboard/lead-management/enquiries/${id}?customer=${encodeURIComponent(
  ...
  const handleRouteToAddLeadAndEnquiry = () => {
    router.push(`/${tenant}/dashboard/lead-management/lead-list/add-lead-enquiry`);
  };
            ...
            {leads.map((lead, index) => (
              ...
              >
                ...
                <td className="px-3 py-2 border border-gray-100">
                 ...
                 // Button
                    onClick={() => {
                      router.push(`/${tenant}/dashboard/lead-management/lead-list/leadDetails/${lead.id}`);
