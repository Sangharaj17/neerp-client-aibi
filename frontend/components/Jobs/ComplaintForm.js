...
import SignatureCanvas from 'react-signature-canvas'; // <<<< NEW IMPORT for signature pad
...
export default function ComplaintForm({
    ...
    const handleBreakdownSubmit = async (e) => {
        ...
        const payload = {
            ...
            executiveId: empData.executiveId || 0, 
        ...
        const endpoint = cleanRenewalId
            ? '/api/amc/jobs/add-amc-renewal-job-activity'
            : '/api/amc/jobs/add-amc-job-activity';
        ...
        return (
            <form onSubmit={handleBreakdownSubmit} 
              style={{...styles.form, marginTop: '25px', padding: '15px', border: '1px solid #ccc', borderRadius: '5px'}}>
                ...
                {/* NEW FIELDS: Type of Work & Description */}
                <div style={styles.row}>
                    ...
                    <div style={styles.inputGroupHalf}>
                        <label htmlFor="description" style={styles.label}>Detailed Description <span style={{color: 'red'}}>*</span></label>
                        <input type="text" id="description" value={empActivityData.description} onChange={handleEmpActivityChange} style={styles.input} required/>
                    </div>
                </div>
                
                {/* 3. Time & Date Fields (Shared) */}
                <div style={styles.inputGroup}>
                ...
                <div style={styles.inputGroup}>
                    ...
                    <textarea id="remark" rows="2" value={empActivityData.remark} onChange={handleEmpActivityChange} style={styles.textarea} />
                </div>
                ...
                <div style={{...styles.inputGroup, border: '1px solid #ffcc00', padding: '10px', borderRadius: '4px', backgroundColor: '#fffbe5', marginTop: '20px'}}>
                    <label style={styles.checkboxLabel}>
                        <input 
                            ...
                            checked={!!empActivityData.signatureBase64} // True if Base64 data exists
                            onChange={() => {}} // Disabled to prevent manual override
                ...
                <button 
                    ...
                    disabled={empSubmitStatus === 'submitting' || empLoading || !empActivityData.signatureBase64} // Disabled if no signature
                >
