        ...
        {[
          ...
          <button
            ...
            onClick={label === "Back To List" ? 
              handleBack : label === "Add Job Activity" ? 
              handleAddActivity : label === "Export Job Activity to Excel" ? 
              exportJobActivityToExcel : label === "Export Activity Details to PDF" ? 
              exportActivityDetailsToPDF : null}
