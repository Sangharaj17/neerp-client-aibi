...
//        }
        ...
        //Optional<User> userOpt = userService.validateUser(request.getEmail(), request.getPassword());
...
//    public ResponseEntity<?> forceLogin(@RequestBody LoginRequest request, HttpServletRequest httpRequest, HttpServletResponse response) {
