...
public class AmcRenewalJobActivityService {

	@Autowired private  AmcRenewalJobActivityRepository amcJobActivityRepository;
	@Autowired private  AmcRenewalJobRepository amcJobRepository;
	...
	public void addJobActivity(AmcJobActivityRequestDto dto) {
	    ...
	    AmcRenewalJob job = amcJobRepository.findById(dto.getRenewalJobId())
	    ...
	    for (Integer liftId : dto.getLiftIds()) {
	        ...
	        AmcRenewalJobActivity activity = AmcRenewalJobActivity.builder()
	                .amcRenewalJob(job)
	...
	public void updateBreakdownTodoStatus(Integer brekdownTodoId) {
		...
		List<AmcRenewalJobActivity> activities = amcJobActivityRepository.findByBreakdownTodo_CustTodoId(brekdownTodoId);
