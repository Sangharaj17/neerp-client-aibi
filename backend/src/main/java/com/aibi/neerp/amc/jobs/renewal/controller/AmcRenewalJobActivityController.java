...
@RestController
@RequestMapping("/api/jobs/renewal/amc-renewal-job-activities")
@RequiredArgsConstructor
@Slf4j
public class AmcRenewalJobActivityController {

    private final AmcRenewalJobActivityService amcJobActivityService;
