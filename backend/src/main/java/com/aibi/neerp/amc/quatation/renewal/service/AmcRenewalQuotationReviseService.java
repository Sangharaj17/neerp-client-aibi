...
@Service
public class AmcRenewalQuotationReviseService {
	
	@Autowired 
	private RevisedRenewalAmcQuotationRepository revisedAmcQuotationRepository;
	@Autowired
	private  AmcRenewalQuotationRepository repository;
	@Autowired
	...
	public void createAmcRenewalRevisedQuotation(AmcRenewalQuotationRequestDto dto) {
        ...
        AmcRenewalQuotation amcQuotation = dto.getAmcRenewQuatationId()!=null ? repository.findById(dto.getAmcRenewQuatationId()).get() : null;
        ...
        long noOfRecords = revisedAmcQuotationRepository.countByAmcRenewalQuotation_RenewalQuaId(dto.getAmcRenewQuatationId());
        noOfRecords++;
        ...
        // --- Build AMC Quotation ---
        RevisedRenewalAmcQuotation revisedAmcQuotation = RevisedRenewalAmcQuotation.builder()
                ...
                .preJobId(amcQuotation.getPreJobId()) 
                .amcRenewalQuotation(amcQuotation)
        ...
        if (dto.getCombinedQuotations() != null) {
            for (AmcCombinedQuotationRequestDto cqDto : dto.getCombinedQuotations()) {
                AmcCombinedQuotation combined = AmcCombinedQuotation.builder()
                        ...
                        .revisedRenewal(revisedAmcQuotation)
	...
	public List<AmcQuotationRenewalResponseDto> getAllRenewRevisedQuotationsByQuotationId(Integer quotationId) {
		  List<RevisedRenewalAmcQuotation> revisedQuotations = 
		            revisedAmcQuotationRepository.findAllByAmcRenewalQuotation_RenewalQuaIdOrderByRevisedRenewalIdDesc(quotationId);
		...
		private AmcQuotationRenewalResponseDto mapToDto(RevisedRenewalAmcQuotation entity) {
		    return AmcQuotationRenewalResponseDto.builder()
		            .id(entity.getRevisedRenewalId())
		 ...
		 public EditRenewQuotationResponseDto getRenewalRevisedQuotationById(Integer id) {
		        RevisedRenewalAmcQuotation amcQuotation = revisedAmcQuotationRepository.findById(id)
		        ...
		        List<CombinedQuotationDto> combinedQuotationDtos = combinedQuotations.stream()
		                .map((AmcCombinedQuotation cq) -> CombinedQuotationDto.builder()
		                        ...
		                        .revisedRenewalId(cq.getRevisedRenewal() != null ? cq.getRevisedRenewal().getRevisedRenewalId(): null)
		        ...
		        return EditRenewQuotationResponseDto.builder()
		        		.amcRenewQuatationId(amcQuotation.getAmcRenewalQuotation().getRenewalQuaId())
		        		.revisedRenewQuatationId(amcQuotation.getRevisedRenewalId())
